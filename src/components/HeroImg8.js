...
const HeroImg8 = () => {
    ...
    return (
        <div className="hero">
            <div className="mask_8" ref={containerRef}>
                ...
                <img className="parallax buddha" src={buddha} data-speedx="0.7" data-speedy="0.30" data-rotation="0" data-distance="0"alt="buddha-img"/>
                <img className="parallax mountain_11" src={mountain_7} data-speedx="0.6" data-speedy="0.20" data-rotation="0" data-distance="0" alt="background-mountain"/>
                ...
                <div className="parallax text-parallax" data-speedx="0.07" data-speedy="0.07" data-rotation="0.11" data-distance="0">
                    <h1 ref={h1_ref}>THANK YOU</h1>
                    <h2 ref={h2_ref}>Created by Brendon Thai</h2>
                </div>
